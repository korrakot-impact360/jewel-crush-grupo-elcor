...
.defines(function(){
	EntityStageBox = EntityClickBtn.extend({
		...
		create:function(){
			...
			this.showStage = ig.game.addText(0, -this.size.y * 0.1, this.stageId + '', 120, fonts.font1);
			this.showStage.anchor.setTo(0.5);
			this.addChild(this.showStage);

			this.comingSoon = ig.game.addText(0, 0, _STRINGS['Game']['comingsoon'], 36, fonts.font1);
